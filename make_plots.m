...
if RUN_ALL_SCENARIOS
    ...
    labels = {'PENSION ONLY (\kappa=0.07, no housing)', ...
              'HOUSING ONLY renter (\kappa=0)', ...
              'HOUSING ONLY owner (\kappa=0)', ...
              'FULL renter (\kappa=0.07 + housing)', ...
              'FULL owner (\kappa=0.07 + housing)'};
    ...
    labels       = {'FULL renter (\kappa=0.07 + housing)', ...
                     'FULL owner (\kappa=0.07 + housing)'};
